...
const playSmartAudio = (text) => {
    ...
    try {
        ...
        // Intentar buscar voces árabes de calidad
          ...
          <div className="flex-1 w-full max-w-4xl flex flex-col md:flex-row gap-3">
            ...
            <div className="flex gap-2">
                <button 
                    ...
                    title="Juegos"
                >
                    {/* Usamos Loader2 como icono de juegos temporalmente si Gamepad no existe */}
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col relative">
        <div className="bg-slate-800 p-6 text-white flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-bold text-2xl">Arcade</h2>
          </div>
    ...
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col relative">
        ...
        <div className="h-12 flex items-center justify-center bg-slate-100 border-t border-slate-200">
          {selectedOption && (isCorrect ? <span className="text-green-600 font-bold flex items-center gap-2 animate-bounce"><Check className="w-5 h-5"/> ¡Correcto!</span> : <span className="text-red-500 font-bold flex items-center gap-2 animate-shake"><Frown className="w-5 h-5"/> ¡Ooops!</span>)}
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col relative">
        ...
        <div className="h-12 flex items-center justify-center bg-slate-100 border-t border-slate-200">
          {selectedOption && (isCorrect ? <span className="text-green-600 font-bold flex items-center gap-2 animate-bounce"><Check className="w-5 h-5"/> ¡Correcto!</span> : <span className="text-red-500 font-bold flex items-center gap-2 animate-shake"><Frown className="w-5 h-5"/> ¡Ooops! Era la marcada en verde</span>)}
        </div>
      </div>
    </div>
  );
                            ...
                            >
                                ...
                                >
                                    <div className="absolute inset-0 backface-hidden bg-emerald-600 rounded-xl border-2 border-emerald-700 flex items-center justify-center shadow-md" style={{ backfaceVisibility: 'hidden' }}>
                                        <ImageIcon className="text-white/30 w-10 h-10" />
                                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col relative">
                ...
                <div className="p-8 text-center">
                    ...
                    <div className="flex flex-col gap-3">
                        <button onClick={() => startGame(3)} className="p-4 bg-red-100 text-red-700 rounded-xl font-bold border-2 border-red-200 hover:bg-red-200 flex items-center justify-between group">
                            <span className="flex items-center gap-2"><Zap className="w-5 h-5"/> Experto (3s)</span>
                            <ArrowRight className="w-5 h-5 opacity-0 group-hover:opacity-100 transition"/>
                        </button>
                        <button onClick={() => startGame(5)} className="p-4 bg-orange-100 text-orange-700 rounded-xl font-bold border-2 border-orange-200 hover:bg-orange-200 flex items-center justify-between group">
                            <span className="flex items-center gap-2"><Loader2 className="w-5 h-5"/> Normal (5s)</span>
                            <ArrowRight className="w-5 h-5 opacity-0 group-hover:opacity-100 transition"/>
                        </button>
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col relative h-[500px]">
        ...
        <div className="bg-rose-600 p-4 text-white flex justify-between items-center shrink-0">
          <div className="flex items-center gap-2">
            <button onClick={() => setGameState('menu')} className="hover:bg-rose-500 p-1 rounded mr-2"><ArrowLeft className="w-5 h-5"/></button>
            <h2 className="font-bold text-lg">Velocidad</h2>
          </div>
          <button onClick={onClose} className="hover:bg-rose-500 p-1 rounded"><X className="w-6 h-6" /></button>
        </div>
        ...
        {gameOver ? (
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center animate-fade-in-up">
                ...
                <button onClick={() => startGame(selectedDuration)} className="w-full bg-rose-600 text-white py-3 rounded-xl font-bold shadow-lg hover:bg-rose-700 transition">Intentar de nuevo</button>
            </div>
        ) : (
            <div className="flex-1 flex flex-col relative">
                <div className="h-2 bg-slate-200 w-full">
                    <div 
                        ...
                        style={{ width: `${(timer / (selectedDuration * 100)) * 100}%` }}
                    />
                </div>
