...
// JUEGO 3: VERDADERO O FALSO (Adaptado con showDiacritics y Selector de Tiempo)
function TrueFalseGame({ onBack, onClose, cards, showDiacritics }) {
  ...
  const [selectedDuration, setSelectedDuration] = useState(null); // 3, 5, 10
  ...
  const startNewRound = (durationOverride = null) => {
    ...
    // Si pasamos un durationOverride es porque venimos del menú
    ...
    // Set timer based on difficulty (seconds * 100 for centiseconds)
    setTimer(limit * 100); 
